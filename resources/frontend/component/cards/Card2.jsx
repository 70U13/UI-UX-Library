const Card2 = ({ text, image, description }) => {
  return (
    <div className="h-auto w-full gap-6 p-6 flex flex-col outline-none bg-white shadow-lg relative overflow-hidden">
        ...
        <div className="flex flex-row justify-end gap-6 p-2">
            <button className="card-btn-standby btn-outline-none w-full max-w-[100px] rounded-[5px] p-5 relative overflow-hidden">
                Cancel
            </button>
            <button className="card-btn-active btn-outline-none w-full max-w-[100px] rounded-[5px] p-5 relative overflow-hidden">
                Buy
            </button>
        </div>
